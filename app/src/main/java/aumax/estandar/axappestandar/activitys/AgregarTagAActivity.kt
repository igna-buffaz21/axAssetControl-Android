...
class AgregarTagAActivity(
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        _oAxLector = AxLector(this@AgregarTagAActivity, Configuracion.MODO_LECTURA.RFID) //creamos el objeto que va a manejar todo el RFID
                ...
                if (leerTagSS) {
                    ...
                    if (listTagsLeidos.size > 1) {
                        ...
                        binding.btnLeerTagSubsector.setBackgroundColor(
                            ContextCompat.getColor(this@AgregarTagAActivity, R.color.black)
                        )
