...
class ActivoControlAdapter :
    ListAdapter<Activo, ActivoControlAdapter.ViewHolder>(DiffCallback()) {//SubSector (tipo de dato para mostrar), SubSectorAdapter.ViewHolder (es el tipo de ViewHolder que vas a usar para mostrar cada ítem), DiffCallback() (es la lógica para comparar si los ítems cambiaron.)
